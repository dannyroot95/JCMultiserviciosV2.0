...
public class TinyDB {
    ...
    public String putImage(String theFolder, String theImageName, Bitmap theBitmap) {
        ...
        this.DEFAULT_APP_IMAGEDATA_DIRECTORY = "slider";
    ...
    public void putListProduct(String key, ArrayList<Product> list){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
    ...
    public ArrayList<Product> getListProduct(String key, Class<Product> java){
        Gson gson = new Gson();
        ...
        for(String jObjString : objStrings){
            Product product  = gson.fromJson(jObjString,  Product.class);
